<template>
    <div style="background-color:white;padding-top:5px;">
        <input type="text" class="form-control" style="margin:5px;width: 98%;" v-show="show_search" v-model="keyword" placeholder="Search ..."/>
        <div class="page-quick-sidebar-chat-users" data-rail-color="#e8fec7" data-wrapper-class="page-quick-sidebar-list">
            ...
            <ul class="media-list list-items">
                <li class="media" v-for="item in filtered_admins" @click="showConversation(item)"
                    ...
                    <div class="media-status" v-if="item.unread > 0">
                        <span class="badge badge-success">{{ item.unread }}</span>
                    </div>
