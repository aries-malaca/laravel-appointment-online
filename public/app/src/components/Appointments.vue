            ...
            <div class="portlet-body">
                <div class="tab-content">
                    <div class="tab-pane active" id="active-appointments">
                        <appointments-table :hide_client="user.is_client===1" @get_appointments="getAppointments"
                                            :paginate="true" :appointments="active_appointments" />
                    </div>
                    <div class="tab-pane" id="appointment-history">
                        <appointments-table :hide_client="user.is_client===1" @get_appointments="getAppointmentHistory"
