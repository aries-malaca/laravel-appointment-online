    ...
    <div class="tab-pane" id="schedules">
        ...
        <div class="tabbable-line">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#operating" data-toggle="tab">Operating Schedules</a>
                </li>
                <li>
                    <a href="#shifting" data-toggle="tab">Technician Shifting</a>
                </li>
            </ul>
                ...
                <div id="shifting" class="tab-pane">
                    <div v-if="branch.cluster_data.ems_supported">
                        <div class="alert alert-info">
                            Selected Branch is EMS Supported. Click here: <a href="http://ems.lay-bare.com">http://ems.lay-bare.com</a> to login.
                        </div>
                    </div>
                    <div v-else>
...
<script>
    export default {
        ...
        watch:{
            branch:function(){
                if(this.branch.branch_data !== undefined)
                    if(this.branch.branch_data.technician_shiftings !== undefined)
                        this.technicianSchedules = this.branch.branch_data.technician_shiftings;
            }
        }
    }
</script>